...
public class HandDetection : MonoBehaviour
{
    ...
    void Update()
    {
        if (webCamTextureManager != null && webCamTextureManager.WebCamTexture != null && webCamTextureManager.WebCamTexture.isPlaying && !m_IsDetecting)
        {
            m_IsDetecting = true;
            m_DetectAwaitable = Detect(webCamTextureManager.WebCamTexture);
        }
    }
